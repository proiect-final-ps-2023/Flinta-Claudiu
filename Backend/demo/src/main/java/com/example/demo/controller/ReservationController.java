...
public class ReservationController {
    ...
    public Reservation addReservation(@RequestParam Long id,
        ...
        if(u!= null && r != null && h!= null )
        {
            ...
            ReservationXML rrXML= new ReservationXML(rr.getStartDate(),rr.getEndDate(),rr.getHotel().getAddress(), h.getEmail(), h.getTelefon(), u.getFirstName(), u.getLastName(), u.getEmail(), r.getName(),r.getPricePerNight());
